...
$(function () {
    $('.tab01 > div').hide();
    $('.dessert_in a').click(function () {
        $('.tab01 > div').hide().filter(this.hash).fadeIn();
        $('.dessert_in a').removeClass('active');
        $(this).addClass('active');
        return false;
    }).filter(':eq(0)').click();
});
...
$(function () {
    $('.tab02 > div').hide();
    $('.drink_in a').click(function () {
        $('.tab02 > div').hide().filter(this.hash).fadeIn();
        $('.drink_in a').removeClass('active');
        $(this).addClass('active');
        return false;
    }).filter(':eq(0)').click();
});
...
$(function(){
    $('.pop1').click(function(){
        $('.box').show();//.fadeIn(); 서서히 나타남
    });
    $('.box a').click(function(){
        $('.box').hide();//.fadeOut(); 서서히 사라짐
    });
});